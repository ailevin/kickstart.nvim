...
vim.g.have_nerd_font = true --Changed to true becsuse I instalaled one NEW

--New additions from my init for my apps
...
-- Make line numbers default window by window
vim.wo.number = true
...
vim.wo.signcolumn = 'yes'  -- changed to wo New
...
-- Set completeopt to have a better completion experience New
...
require('lazy').setup({
  ...
  },
  {
    ...
    config = function()
      ...
      --
      -- LSP stands for anguage Server Protocol. It's a protocol that helps editors
      ...
      vim.lsp.config('lua_ls', {
        cmd = { 'lua-language-server' }, -- You must specify the command manually here
        settings = {
          Lua = {
            diagnostics = { globals = { 'vim' } },
            workspace = { checkThirdParty = false },
          },
          root_markers = { '.git', 'init.lua', 'package.json' },
        },
      })
